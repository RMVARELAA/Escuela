...
namespace Escuela.Controllers
{
    ...
    public class MatriculaController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<Matricula>>> AddClaseAlumno(Matricula matricula)
        {
            try
            {
                // Obtenemos el número de registros para este alumno.
                int numRegistros = await _context.Matriculas
                    .Where(m => m.IdAlumno == matricula.IdAlumno)
                    .CountAsync();

                // Verificamos si el número de registros es menor o igual a 5.
                if (numRegistros >= 5)
                {
                ...
                // Obtenemos la sección relacionada con la matrícula
                ...
                // Verificamos si la clase ya está matriculada por el mismo alumno
                ...
                // Verificamos si el alumno tiene una o más veces matriculada la misma clase (aunque sean en diferentes horarios)
                ...
                // Verificamos si el alumno ya está matriculado en una sección con la misma hora inicial
